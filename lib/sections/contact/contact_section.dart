    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          fit: BoxFit.cover,
          image: AssetImage("assets/images/bg_img_2.webp"),
        ),
      ),
      child: Container(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              SocalCard(
                ...
                iconSrc: "assets/images/whatsapp.webp",
                name: 'WhatsApp',
                press: () async{
              ...
              SocalCard(
                ...
                iconSrc: "assets/images/telegram.webp",
                name: 'Telegram',
                press: () async{
              ...
              SocalCard(
                color: Color(0xFFE8F0F9),
                iconSrc: "assets/images/messenger.webp",
                name: 'Messenger',
                press: () async{
            ...
            children: [
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset("assets/images/contact_email.webp", height: 30,width: 30,),
                    SizedBox(width: 7,),
              ...
              InkWell(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Image.asset("assets/images/phone.webp", height: 30,width: 30,),
                    SizedBox(width: 7,),
          ...
          SizedBox(height: 2*kDefaultPadding),
          DefaultButton(
            imageSrc: "assets/images/contact_icon.webp",
            text: "Contact Me!",
            press: () async{
              const url = 'mailto:mahmud@prottoy.com.bd';
              if (await canLaunch(url)) {
